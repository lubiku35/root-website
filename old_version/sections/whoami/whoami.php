<section id='whoami'>
    <h2>whoam<span class="handler-letter-spacing">i</span></h2>
    <main id='main-content'>
        <img src='./assets/imgs/author.png' alt='photo of the author - lubiku'>
        <section id='about-author-content'>
            <p id='lines-content'>\ \ \ \ \</p>
            <h3 id='about-author-heading'>luboslav motosicky</h3>
            <p id='about-author-text'>author of the project - luboslav motosicky alias 'lubiku', student of software
                engineering and information technology, currently located in czech republic - prague. working as junior
                information security expert at mycom solutions company.</p>
            <p id='additional-text'>to find out more about author, just navigate to <a href='http://'
            ...
            <footer id='about-author-footer'>
                <a href='./under-maintenance.php'>discover more</a>
