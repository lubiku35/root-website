...
<body>
    ...
    <section id="register">
        ...
        <form action="" id="reg-form">
            ...
            <p class="reg-client-error-message" id="client-error-name"></p>
            ...
            <p class="reg-client-error-message" id="client-error-username"></p>
            ...
            <p class="reg-client-error-message" id="client-error-email"></p>
            ...
            <p class="reg-client-error-message" id="client-error-password"></p>
            ...
            <p class="reg-client-error-message" id="client-error-password-repeat"></p>
            ...
            <p class="reg-client-error-message" id="client-error-conditions"></p>
